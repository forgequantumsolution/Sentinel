...
-- Rule: User.RoleId Equals <role-id> → auto-assign to group
...
SELECT gen_random_uuid(), 'super-admin Role Rule', 'Auto-assign users with super-admin role', 'User.RoleId', 0, g."RoleId"::TEXT, false, true, 0, g."Id", true, true, false, NOW(), g."OrganizationId"
FROM "UserGroups" g
WHERE g."Name" = 'super-admin Role' AND g."Type" = 0 AND g."OrganizationId" = org_id
  AND NOT EXISTS (SELECT 1 FROM "DynamicGroupingRules" rr WHERE rr."UserGroupId" = g."Id" AND rr."Field" = 'User.RoleId' AND rr."IsDeleted" = false);

INSERT INTO "DynamicGroupingRules" ("Id", "Name", "Description", "Field", "Operator", "Value", "IsDynamicValue", "IsHidden", "RuleType", "UserGroupId", "AutoAssign", "IsActive", "IsDeleted", "CreatedAt", "OrganizationId")
SELECT gen_random_uuid(), 'sys-admin Role Rule', 'Auto-assign users with sys-admin role', 'User.RoleId', 0, g."RoleId"::TEXT, false, true, 0, g."Id", true, true, false, NOW(), g."OrganizationId"
FROM "UserGroups" g
WHERE g."Name" = 'sys-admin Role' AND g."Type" = 0 AND g."OrganizationId" = org_id
  AND NOT EXISTS (SELECT 1 FROM "DynamicGroupingRules" rr WHERE rr."UserGroupId" = g."Id" AND rr."Field" = 'User.RoleId' AND rr."IsDeleted" = false);

INSERT INTO "DynamicGroupingRules" ("Id", "Name", "Description", "Field", "Operator", "Value", "IsDynamicValue", "IsHidden", "RuleType", "UserGroupId", "AutoAssign", "IsActive", "IsDeleted", "CreatedAt", "OrganizationId")
SELECT gen_random_uuid(), 'admin Role Rule', 'Auto-assign users with admin role', 'User.RoleId', 0, g."RoleId"::TEXT, false, true, 0, g."Id", true, true, false, NOW(), g."OrganizationId"
FROM "UserGroups" g
WHERE g."Name" = 'admin Role' AND g."Type" = 0 AND g."OrganizationId" = org_id
  AND NOT EXISTS (SELECT 1 FROM "DynamicGroupingRules" rr WHERE rr."UserGroupId" = g."Id" AND rr."Field" = 'User.RoleId' AND rr."IsDeleted" = false);

INSERT INTO "DynamicGroupingRules" ("Id", "Name", "Description", "Field", "Operator", "Value", "IsDynamicValue", "IsHidden", "RuleType", "UserGroupId", "AutoAssign", "IsActive", "IsDeleted", "CreatedAt", "OrganizationId")
SELECT gen_random_uuid(), 'user Role Rule', 'Auto-assign users with user role', 'User.RoleId', 0, g."RoleId"::TEXT, false, true, 0, g."Id", true, true, false, NOW(), g."OrganizationId"
FROM "UserGroups" g
