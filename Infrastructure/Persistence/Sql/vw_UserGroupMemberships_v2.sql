-- ===================================================================
-- v2: Permissions are now read from ActionObjectPermissionAssignments
--     (AssigneeType = Group), replacing the old DynamicGroupObjectPermissions
--     → ActionObjectPermissionSets chain.
-- ===================================================================
...
--   User → (grouping rules) → UserGroup → ActionObjectPermissionAssignment (Group assignee)
...
-- Join permissions assigned to the group via ActionObjectPermissionAssignments
